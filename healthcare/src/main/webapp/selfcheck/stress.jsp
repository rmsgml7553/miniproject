...
<body>
	<form action="${pageContext.request.contextPath }/selfcheck/stress.do"
		method="post" name="f">
		<div class="container">
			<h2>스트레스 테스트</h2>
			<p>해당하는 문항에 체크</p>
			<div class="table-responsive">
					...
					<tbody>
						<c:forEach var="vo" items="${list }">
							<tr>
								<td>${vo.arg1 }</td>
								<td>${vo.arg2 }</td>
								<td><input type="radio" name="${vo.arg1 }" value="0"
									checked></td>
				...
				<p style="text-align: right;">
					<button type="submit" class="btn btn-default">결과보기</button>
				</p>
