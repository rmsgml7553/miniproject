                ...
                data: { // 차트에 들어갈 데이터
                    ...
                    datasets: [
                        { //데이터
                            ...
                            data: [
                            	${amr},'1500','2500','500'//x축 label에 대응되는 데이터 값
                            ],
                            backgroundColor: [
                                //색상
                                'rgba(255, 99, 132, 0.2)',
                ...
                data: { // 차트에 들어갈 데이터
                    ...
                    datasets: [
                        { //데이터
                            ...
                            fill: false, // line 형태일 때, 선 안쪽을 채우는지 안채우는지
                            data: [
                            	${bmr},'1500','2500','500'//x축 label에 대응되는 데이터 값
                            ],
                            backgroundColor: [
                                //색상
                                'rgba(255, 99, 132, 0.2)',
                ...
                data: { // 차트에 들어갈 데이터
                    ...
                    datasets: [
                        { //데이터
                            ...
                            fill: false, // line 형태일 때, 선 안쪽을 채우는지 안채우는지
                            data: [
                            	${bmi},'50','100','10'//x축 label에 대응되는 데이터 값
                            ],
                            backgroundColor: [
                                //색상
                                'rgba(255, 99, 132, 0.2)',
                ...
                data: { // 차트에 들어갈 데이터
                    ...
                    datasets: [
                        { //데이터
                            ...
                            fill: false, // line 형태일 때, 선 안쪽을 채우는지 안채우는지
                            data: [
                            	${stress},'50','100','10'//x축 label에 대응되는 데이터 값
                            ],
                            backgroundColor: [
                                //색상
                                'rgba(255, 99, 132, 0.2)',
...
// 	        infowindow.open(map, marker);
	...
	function getTimeHTML(distance) {
	    ...
	    if (walkkTime > 60) {
	        walkHour = '<span class="number">' + Math.floor(walkkTime / 60) + '시간</span>'
	    }
	    walkMin = '<span class="number">' + walkkTime % 60 + '분</span>'
	    ...
	    if (bycicleTime > 60) {
	        bycicleHour = '<span class="number">' + Math.floor(bycicleTime / 60) + '시간</span>'
	    }
	    bycicleMin = '<span class="number">' + bycicleTime % 60 + '분</span>'

	    // 거리와 도보 시간, 자전거 시간을 가지고 HTML Content를 만들어 리턴합니다
	    var content = '<ul class="info">';
	    content += '    <li>';
	    content += '        <span class="label">총거리</span><span class="number">' + distance + 'm</span>';
	    content += '    </li>';
	    content += '    <li>';
