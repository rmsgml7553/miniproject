...
<input type="text" name="id" size="50" autofocus required placeholder="아이디를 입력해주세요.">
<input type="button" onclick="id_check()" value="중복확인">
<br/>
필수정보 입니다.<br/>
<label for="pwd">비밀번호</label><br/>
<input type="password" name="pwd" size="50" autofocus required placeholder="비밀번호를 입력해주세요."><br/>
필수정보 입니다.<br/>
<label for="pwd2">비밀번호 재확인</label><br/>
<input type="password" name="pwd2" size="50" autofocus required placeholder="비밀번호를 입력해주세요."><br/>
필수정보 입니다.<br/>
<label for="name">이름</label><br/>
<input type="text" name="name" size="50" autofocus required placeholder="이름을 입력해주세요."><br/>
필수정보 입니다.<br/>
...
<input type="button" value="회원가입" size="50" onclick="joinform_check()">
</fieldset>
</form>
</body>
</html>