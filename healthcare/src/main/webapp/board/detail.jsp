...
<h3>글작성 페이지</h3>
<a href="${pageContext.request.contextPath }/board/list">글목록으로 이동</a><br/>
<a href="${pageContext.request.contextPath }/like_board?id=${sessionScope.loginId}&num=${vo.num}">좋아요 누르기</a><td>${count }</td>
