...
<!-- 						<table class="table table-hover"> -->
							...
							<table class="table ">
								...
								<tr><td><textarea rows="20" style="width: 100%;" name="content" >${vo.content }</textarea></td></tr>
...
<button type="button" class="btn btn-primary btn-sm" onclick = "javascrip:location.href='${pageContext.request.contextPath }/board/list.do'" style="float:right;background-color:rgb(233, 236, 239);color:black;border: 0px">목록</button><br/><br/>
				...
				<form action = "${pageContext.request.contextPath }/board_rep/add.do?num=${vo.num}" method ="post">
				 ...
				 <div class="input-group-append">
					<input type = "text" name = "content" class="form-control" style="width:90%;display:inline;margin-bottom:20px" >
						...
						<input type = "submit" class="btn btn-light" style="float:right;background-color: rgb(233, 236, 239);" value = "댓글 작성">
					</div>
