...
.myModal {
 ...
 a:link { color: blck; text-decoration: none;}
...
<div class="container">
<h3 style = "margin-bottom:50px; font-weight: bold;" >자유게시판</h3>
...
<c:if test = "${not empty sessionScope.loginId }">
	<button type="button" class="btn btn-primary btn-sm" style="background-color:rgb(233, 236, 239);color:black;float:right;border: 0px" onclick ="javascript:location.href='${pageContext.request.contextPath}/board/add.do?id=${sessionScope.loginId}'">글 작성</button>
</c:if>
</div>
</section>
