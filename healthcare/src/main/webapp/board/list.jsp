...
<a href="${pageContext.request.contextPath}/board/add.do?id=${sessionScope.loginId}">글작성 페이지로 이동합니다.</a></<br/> <!-- 디스패처로 이동한다. -->

<table border="1">
<tr><th>번호</th><th>작성자</th><th>제목</th><th>내용</th><th>조회수</th><th>작성일</th></tr>
...
<td>${vo.content }</td><td>${vo.cnt }</td><td>${vo.w_date }</td> 
</tr>
</c:forEach>
