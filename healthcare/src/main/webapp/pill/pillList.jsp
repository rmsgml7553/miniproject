...
<script>
	function b(num) {
		let modal = document.getElementById("dtail-body");
			...
			<table class = "table table-hover">
				...
				<tbody>
					<c:forEach var="vo" items="${list }">
						<tr>
							<td><button type="button" onclick="b('${vo.itemSeq}')" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#detail" style="background-color: rgb(248, 249, 250);color: RGB(58, 162, 201);font-weight: bold;border: 0px;">${vo.entpName }</button></td>
							<td>${vo.itemName }</td>
						</tr>
					</c:forEach>
				</tbody>
			...
			<div class="modal-dialog modal-dialog-centered" >
               <div class="modal-content">
				<!-- Modal Header -->
                  ...
                  <!-- Modal body -->
                  <div class="modal-body" id = "dtail-body">
                     
                  </div>
                  
                  <!-- Modal footer -->
                  <div class="modal-footer">
			        <button type="button" class="btn btn-danger" data-bs-dismiss="modal" style=";background-color:rgb(233, 236, 239);color:black;border: 0px;">Close</button>
			      </div>
               </div>
            </div>
         </div>
